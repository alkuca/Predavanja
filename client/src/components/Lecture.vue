                    ...
                    <div class="top-right">
                        ...
                        <div class="date-countdown">
                            <div v-if="!lectureCompleted">
                                ...
                                <p>{{ peopleInterested.length }} {{ peopleInterested.length === 1 ? "Person is interested" : "People are interested" }}</p>
                            </div>
                            <div class="complete-section" v-if="lectureCompleted">
                              <h1 class="complete-text">LECTURE COMPLETED</h1>
                              <p>{{ peopleInterested.length }} {{ peopleInterested.length === 1 ? "Person attended this lecture" : "People attended this lecture" }}</p>
                        ...
                        <div class="section-bottom-content">
                            ...
                            <transition name="fade">
                                <div v-if="notesToggle" class="section-bottom-container">
                                    <p v-if="notes.length === 0 && !lectureCompleted">The Lecturer did not post any notes yet</p>
